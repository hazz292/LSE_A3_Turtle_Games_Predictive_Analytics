...
upperb <- Q3 + (IQR * 1.5)
  # Print upper bound
  upperb
    # Data points greater than upperbound are outliers
...
# Remove outliers using upperbound
new_global <- filter(sales, Global_Sales < upperb)
...
# Remove outliers
new_na <- filter(sales, NA_Sales < upperb)
...
# Remove outliers
new_eu <- filter(sales, EU_Sales < upperb)
